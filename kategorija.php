...
<body>
  ...
  <main>
    ...
    if($id == "KULTURA"){
        echo '<h2 class="hnews" style="border-left: 5px solid red;">Kultura</h2>';
    }elseif($id == "SPORT"){
        echo '<h2 class="hnews" style="border-left: 5px solid rgb(241, 213, 52);">Sport</h2>';
    }

    $sql = "SELECT * FROM vijesti WHERE arhiva = 0 AND kategorija = '$id'";
